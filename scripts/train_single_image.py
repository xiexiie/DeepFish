...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--datadir',
                        type=str, default='F:/PostGraduate/数据集/DeepFish/DeepFish')
    # parser.add_argument('-d', '--datadir',
    #                     type=str,
    #                     default='F:/PostGraduate/数据集/DeepFish/DeepFish/Localization/images/valid/7117_Caranx_sexfasciatus_juvenile_f000000.jpg')
